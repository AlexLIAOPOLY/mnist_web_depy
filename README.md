...
An interactive web application for training, testing, and visualizing neural network models on the MNIST dataset.

![MNIST Web App Screenshot](mnist_web/static/img/screenshot.png)

## Features

- **Train Models**: Train neural network models with customizable hyperparameters
- **Test Predictions**: Draw digits and see real-time predictions
- **Explore Dataset**: Visualize and understand the MNIST dataset
- **Compare Models**: Compare different models' performance and view detailed metrics
- **Visualize**: View confusion matrices, t-SNE visualizations, and more

## Demo

A live demo of the application is available at: [https://mnist-web-app.onrender.com](https://mnist-web-app.onrender.com)
...
- `--preload`: Preload the MNIST dataset on startup

Example:
```
python run_mnist_web.py --host 0.0.0.0 --port 8080 --preload
```
