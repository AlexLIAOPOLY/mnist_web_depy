...
class SimpleNeuralNetwork:
    ...
    def load(cls, filename):
        ...
        model = cls(arch['input_size'], arch['hidden_size'], arch['output_size'], arch['activation'])
...
def main():
    ...
    model.train(x_train_subset, y_train_subset, x_val, y_val, epochs=5, batch_size=64, learning_rate=0.1)
